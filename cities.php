...
$cities = [
    ...
    [
        'name' => 'Balıkesir',
        'districts' => ['Altieylül', 'Ayvalık', 'Balya', 'Bandırma', 'Bigadiç', 'Burhaniye', 'Dursunbey', 'Edremit', 'Erdek', 'Gömeç', 'Gönen', 'Havran', 'İvrindi', 'Karesi', 'Kepsut', 'Manyas', 'Marmara', 'Savaştepe', 'Sındırgı', 'Susurluk']
    ],
    [
        'name' => 'Bilecik',
    ...
    [
        'name' => 'Burdur',
        'districts' => ['Ağlasun', 'Altinyayla', 'Bucak', 'Çavdır', 'Çeltikçi', 'Gölhisar', 'Karamanlı', 'Kemer', 'Merkez', 'Tefenni', 'Yeşilova']
    ],
    [
        'name' => 'Bursa',
    ...
    [
        'name' => 'İstanbul',
        'districts' => ['Adalar', 'Arnavutköy', 'Ataşehir', 'Avcılar', 'Bağcılar', 'Bahçelievler', 'Bakırköy', 'Başakşehir', 'Bayrampaşa', 'Beşiktaş', 'Beykoz', 'Beylikdüzü', 'Beyoğlu', 'Büyükçekmece', 'Çatalca', 'Çekmeköy', 'Esenler', 'Esenyurt', 'Etiler', 'Eyüpsultan', 'Fatih', 'Gaziosmanpaşa', 'Güngören', 'Kadıköy', 'Kağıthane', 'Kartal', 'Küçükçekmece', 'Maltepe', 'Pendik', 'Sancaktepe', 'Sarıyer', 'Silivri', 'Sultanbeyli', 'Sultangazi', 'Şile', 'Şişli', 'Tuzla', 'Ümraniye', 'Üsküdar', 'Zeytinburnu']
    ],
    [
        'name' => 'İzmir',
    ...
    [
        'name' => 'Trabzon',
        'districts' => ['Akçaabat', 'Araklı', 'Arsin', 'Beşikdüzü', 'Çaykara', 'Çarşıbaşı', 'Dernekpazarı', 'Düzköy', 'Hayrat', 'Köprübaşı', 'Maçka', 'Of', 'Ortahisar', 'Sürmene', 'Şalpazarı', 'Tonya', 'Vakfıkebir', 'Yomra']
    ],
    [
        'name' => 'Tunceli',
        'districts' => ['Çemişgezek', 'Hozat', 'Mazgirt', 'Merkez', 'Munzur', 'Nazımiye', 'Ovacık', 'Pertek', 'Pülümür']
    ],
    [
        'name' => 'Uşak',
